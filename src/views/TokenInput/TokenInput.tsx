...
import {
	UP_GETTING_STARTED_URL,
	UPSIDE_DN_GITHUB_URL,
	UP_API_URL,
} from "../../constants/urls";
import { FEED_PATH } from "../../constants/routes";

const tokenFormatExample =
		...
		<Stack spacing={6}>
			...
			<Box>
				...
				<Text>
					...
					<ExternalLink href={UP_API_URL}>Up Bank API</ExternalLink> to make
          secure requests for your data in the browser.
        </Text>
			</Box>
			<Box>
          ...
          scrutinize on{" "}
					<ExternalLink href={UPSIDE_DN_GITHUB_URL}>Github</ExternalLink>
				</Text>
			</Box>
                ...
                <AccordionIcon />
							...
							<AccordionPanel paddingTop={2} paddingX={0}>
								<Box maxWidth="100%" wordBreak="break-word">
									<Code children={tokenFormatExample} />
								</Box>
							</AccordionPanel>
						</AccordionItem>
					</Accordion>
